...
class User < ApplicationRecord
  ...
  validates :firstname, length: { maximum: 10 }, format: { multiline: true, with: /^[a-zA-Z]+$/, message: 'only alphabetic characters are allowed.' }, unless: :login_social
  validates :lastname, length: { maximum: 10 }, format: { multiline: true, with: /^[a-zA-Z]+$/, message: 'only alphabetic characters are allowed.' }, unless: :login_social
